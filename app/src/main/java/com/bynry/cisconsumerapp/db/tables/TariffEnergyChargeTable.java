 ...
 */
public class TariffEnergyChargeTable {

    public static final String TABLE_NAME = "TariffEnergyChargeTable";
    public static final String PATH = "TariffEnergyCharge_TABLE";
