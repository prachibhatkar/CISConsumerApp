 ...
 */
public class TariffFixedEnergyChargeTable {

    public static final String TABLE_NAME = "TariffFixedEnergyChargeTable";
    public static final String PATH = "TariffFixedEnergyCharge_TABLE";
