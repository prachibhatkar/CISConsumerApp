...
public class NewConnectionRequestActivity extends BaseActivity implements View.OnClickListener, ServiceCaller
{
...
//        editTextAddress3 = (EditText) findViewById(R.id.editAddressLine3);
    ...
    public boolean validate()
    {
        ...
        if (!fullname.isEmpty() && fullname.toString().length() <= 40)
        {
            ...
            {
                if ( address2.toString().length() <= 150)
                {
            ...
            case AppConstants.REQUEST_NEW_CONNECTION:
            {
                if (jsonResponse != null)
                {
                    if (jsonResponse.result != null && jsonResponse.result.equals(JsonResponse.SUCCESS)) {
                        ...
                        i = new Intent(this, NewConnectionSuccessActivity.class);
                        startActivity(i);
