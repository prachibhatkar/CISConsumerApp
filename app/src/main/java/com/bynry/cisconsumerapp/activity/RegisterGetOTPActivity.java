...
public class RegisterGetOTPActivity extends BaseActivity implements View.OnClickListener, ServiceCaller
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_registerget_otp);
        mContext = this;
